...
public class KeyboardUtil {
  ...
  private KeyboardUtil(Activity activity, EditText edit, KeyboardView keyboard) {
    mActivity = activity;
    this.ed = edit;
  ...
  public static KeyboardUtil shared(Activity activity, EditText edit,KeyboardView keyboardView) {
    if (mInstance == null) {
      mInstance = new KeyboardUtil(activity, edit, keyboardView);
    }
    mInstance.ed = edit;
    return mInstance;
  }
